...
INSERT INTO ai_provider_connections(code,display_name,provider_type,base_url,default_model_id,privacy_class,status,last_test_status) VALUES
 ('ollama-cloud','Ollama Cloud','OLLAMA','https://ollama.com/api','qwen3:14b','CLOUD','CONFIGURED','NOT_TESTED'),
 ('ollama-local','Ollama Local','OLLAMA','http://localhost:11434/api','qwen3:8b','LOCAL','CONFIGURED','NOT_TESTED'),
 ('mistral-compatible','Mistral Compatible','OPENAI_COMPATIBLE',NULL,'mistral-small3.2','CLOUD','DISABLED','NOT_TESTED'),
 ('qwen-compatible','Qwen Compatible','OPENAI_COMPATIBLE',NULL,'qwen3','CLOUD','DISABLED','NOT_TESTED'),
 ('deterministic-core','Deterministic Core','DETERMINISTIC',NULL,'rules-v1','INTERNAL','QUALIFIED','READY')
